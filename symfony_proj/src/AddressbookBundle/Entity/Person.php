...
{
     /**
     * @ORM\OneToMany(targetEntity="Address", mappedBy="person_id")
      */
    private $addresses;

    /**
        * @ORM\OneToMany(targetEntity="Phone", mappedBy="person_id")
*/
    private $phones;

    /**

* @ORM\OneToMany(targetEntity="Email", mappedBy="person_id")
     */
